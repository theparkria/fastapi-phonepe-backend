...
def create_payment(req: PaymentRequest):
    ...
    if isinstance(phonepe_resp, dict):
        redirect_url = phonepe_resp.get("redirectUrl") or (phonepe_resp.get("data") or {}).get("redirectUrl") or phonepe_resp.get("checkout_url") or phonepe_resp.get("checkoutUrl")
